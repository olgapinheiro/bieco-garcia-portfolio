    ...
    <main className="grid grid-cols-1 p-8 xs:p-16 gap-4 sm:gap-x-16 sm:gap-y-4 md:gap-x-32">
      ...
      <div className="pb-16">
        <p className="max-w-3xl text-center md:text-left">
          This collection highlights the sensory appeal of high-end gastronomy through carefully styled compositions. Each image is designed to enhance the shine, texture, and color of the food, making it look more appetizing and inviting. The goal is to evoke not just taste, but the full dining experience.
        </p>
        <p className="max-w-3xl text-center md:text-left">
